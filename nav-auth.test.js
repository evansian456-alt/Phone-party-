...
describe('AppStateMachine (ui/stateMachine.js)', () => {
  ...
  test('APP_STATE has the five expected states', () => {
    ...
    expect(SM.APP_STATE.IN_PARTY_GUEST).toBe('IN_PARTY_GUEST');
  });
  ...
  test('transitionTo IN_PARTY_GUEST changes state to IN_PARTY_GUEST', () => {
    SM.transitionTo(SM.APP_STATE.IN_PARTY_GUEST);
    expect(SM.getState()).toBe(SM.APP_STATE.IN_PARTY_GUEST);
  });
